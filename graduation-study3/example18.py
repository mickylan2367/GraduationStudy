...
paths = glob.glob("data/ikeda/dist/aaft/u090/**.npy")
ent1 = list()
ent2 = list()
...
##################################################
xx = complexity_entropy(np.load("data/ikeda/dist/original/u090/dist_0.npy"), dx=6, probs=True)
diff1 = ent1 - xx[0]
diff2 = ent2 - xx[1]
