...
# ikeda map
# paths = glob.glob("data/ikeda/original/u090/**.npy")
# hc = []
# for path in paths:
#     data = np.load(path)
#     x = data[:, 0]
#     hc.append(complexity_entropy(x, dx=6))
# hc_ikeda = np.mean(hc, axis=0)
# hc_ikeda = hc_ikeda[-2]

hc_ikeda = np.load("hc/hc_ikeda.npy")
hc_ikeda_aaft = np.load("hc/hc_ikeda_aaft_dx6.npy")



# path for short length of ikeda map
# paths = glob.glob("data/ikeda/original/u090/**.npy")
# hc = []
# for path in paths:
#     data = np.load(path)
...
#     x = x[:2**10]
#     hc.append(complexity_entropy(x, dx=6))
# hc_ikeda_short = np.mean(hc, axis=0)
...
hc_standard_aaft =  np.load("hc/hc_standard_aaft_dx6.npy")
